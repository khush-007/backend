...
const generateAccessAndRefreshToken = async(userId){
    try{
        ...
        throw new ApiError(500,"somthing wong in generate refresh ad access token")
    }
}
...
const registerUser = asyncHandler( async (req,res) => {
    ...
    if(!createdUser){
        throw new ApiError(500,"somethng went wrong while register user")
    }
...
const logoutUser = asyncHandler(async(req,res)=>{
    ...
    .clearCookie("acceccToken",options)
    .clearCookie("refreshToken",options)
...
const getCurrentUser = asyncHandler(async(req,res)=>{
    return res
    .status(200)
    .json(new 200,req.user,"current user fetched successfuly")
});
